...
''' Violine plot '''
# Data
sourceData = pd.read_excel(r".\data_generator\source_data"+ '/Source Data.xlsx', sheet_name = 'F3_Score value_test')
# Figure
...
''' ROC curve '''
# Data
sourceData = pd.read_excel(r".\data_generator\source_data"+ '/Source Data.xlsx', sheet_name = 'F3_ROC curve')
# Figure
...
sourceData = pd.read_excel(r".\data_generator\source_data"+ '/Source Data.xlsx', sheet_name = 'F3_ROC curve by type')
# Figure
