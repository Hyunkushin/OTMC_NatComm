...
''' Box plot '''
# Data
sourceData = pd.read_excel(r".\data_generator\source_data" + '/Source Data.xlsx', sheet_name='F4_Box plot')
# Figure
...
''' ROC curve '''
# Data
sourceData = pd.read_excel(r".\data_generator\source_data" + '/Source Data.xlsx', sheet_name='F4_ROC curve by type')
# Figure
...
labelabbre = ['LUAD', 'BRCA', 'COAD', 'LIHC', 'PAAD', 'STAD']
sourceData = pd.read_excel(r".\data_generator\source_data" + '/Source Data.xlsx', sheet_name='F4_Box plot')
info = pd.read_excel(r".\data_generator\source_data" + '/Sample info.xlsx')
...
for lbl in labelabbre:
    ...
    print(len(result[result['Group'] == "TRGT"]))
